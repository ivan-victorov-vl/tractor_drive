...
extern void PMSMotorFuncInit(Model_Data_PMSM_S *md_l, Settng_Data_PMSM_S *sd_l,
                             Flg_Cntrl_Drive_S *mf_l);
//! declaration of external access to a function PMSMotorFuncReset
extern void PMSMotorFuncReset(Model_Data_PMSM_S *md_l, Settng_Data_PMSM_S *sd_l,
                              Flg_Cntrl_Drive_S *mf_l);
//! declaration of external access to a function PMSMotorFuncScal
extern void PMSMotorFuncScal(Model_Data_PMSM_S *md_la, Flg_Cntrl_Drive_S *mf_la,
                             Brws_Param_Drive *bpd_la);
//! declaration of external access to a function PMSMotorFuncTechSpec
extern void PMSMotorFuncTechSpec(Model_Data_PMSM_S *md_la,
                                 Flg_Cntrl_Drive_S *mf_la,
                                 Brws_Param_Drive *bpd_la);
//! declaration of external access to a function PMSMotorFuncTechSpecWithoutIntenstCntrllr
extern void PMSMotorFuncTechSpecWithoutIntenstCntrllr(Model_Data_PMSM_S *md_la,
                                                      Flg_Cntrl_Drive_S *mf_la,
                                                      Brws_Param_Drive *bpd_la);
//! declaration of external access to a function PMSMotorFuncSensorless
extern void PMSMotorFuncSensorless(Model_Data_PMSM_S *md_la,
                                   Flg_Cntrl_Drive_S *mf_la,
                                   Brws_Param_Drive *bpd_la);
//! declaration of external access to a function CntrlDrive
extern void CntrlDrive(Model_Data_PMSM_S *md_l, Settng_Data_PMSM_S *sd_l,
