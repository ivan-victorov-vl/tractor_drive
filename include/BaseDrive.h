...
//----------------------------------------------------------------------------------------------------------------
// Группа параметра: 					( Данные ПЧ )
// Название идентификационных данных: 	Данные управления преобразователем частоты
// Доступ к регистру 					Чтение / Запись
//----------------------------------------------------------------------------------------------------------------
typedef struct
{
	...
	B32_Numb_S theta;
	// приращающая часть на разгон с n(min) до n(nom)
	B32_Numb_S k_f_mul_plus;
	// приращаюшая часть на замедление с n(nom) до n(min)
	B32_Numb_S k_f_mul_minus;
	// текущее значение положения ротора
	B32_Numb_S cur_pstn_rtr;
	// уровень напряжения фазы U
	B32_Numb_S uu;
	// уровень напряжения фазы V
	B32_Numb_S uv;
	// уровень напряжения фазы W
	B32_Numb_S uw;
	// уровень напряжения звена постоянного тока
	B32_Numb_S udc;
	// положение ротора структуры пид регулятора
