...
extern void ExtrctModbusVal(Rpd_Ctrl_Regs_S *rpd_ctrl_regs_l,
...
extern void PushIndctnCntrlMB(Rpd_Ctrl_Regs_S *rpd_ctrl_regs_l,
                              Flg_Cntrl_Drive_S *flag_ctrl_regs_l);
// объявление внешнего доступа к функции ExtrctModbusValInit
extern void ExtrctModbusValInit(Rpd_Ctrl_Regs_S *rpd_ctrl_regs_l,
                                Flg_Cntrl_Drive_S *flag_ctrl_regs_l,
