...
extern retval_t (*pMaxMotorIPrtctn)(float32 iu_l_a, float32 iv_l_a,
                                    float32 iw_l_a, float32 valmax_prtctn_l_a);
//! declaration of external access to the function pTimeIMotorPrtctn
extern retval_t (*pTimeIMotorPrtctn)(float32 istator_l, float32 ki_integral_l,
...
extern retval_t (*pBreakPhasePrtctn)(float32 urefu_l, float32 urefv_l,
                                     float32 urefw_l, float32 iu_l,
                                     float32 iv_l, float32 iw_l,
                                     float32 valmax_prtctn_l,
                                     float32 ku_multiply_l);
