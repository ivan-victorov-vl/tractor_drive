...
retval_t MaxMotorIPrtctn(float32 iu_l_a, float32 iv_l_a, float32 iw_l_a,
                         float32 valmax_prtctn_l_a);
//! protection function pointer declaration pMaxMotorIPrtctn
retval_t (*pMaxMotorIPrtctn)(float32 iu_l_a, float32 iv_l_a, float32 iw_l_a,
                             float32 valmax_prtctn_l_a) = &MaxMotorIPrtctn;
//! protection function declaration TimeIMotorPrtctn
retval_t TimeIMotorPrtctn(float32 istator_l, float32 ki_integral_l,
                          float32 i_nom_l, float32 *i_intgrl_l,
                          float32 activ_intgr_prtctn_l);
//! protection function pointer declaration pTimeIMotorPrtctn
retval_t (*pTimeIMotorPrtctn)(float32 istator_l, float32 ki_integral_l,
                              float32 i_nom_l, float32 *i_intgrl_l,
                              float32 activ_intgr_prtctn_l) = &TimeIMotorPrtctn;
//! protection function declaration BreakPhasePrtctn
retval_t BreakPhasePrtctn(float32 urefu_l, float32 urefv_l, float32 urefw_l,
                          float32 iu_l, float32 iv_l, float32 iw_l,
                          float32 valmax_prtctn_l, float32 ku_multiply_l);
//! protection function pointer declaration pBreakPhasePrtctn
retval_t (*pBreakPhasePrtctn)(float32 urefu_l, float32 urefv_l, float32 urefw_l,
                              float32 iu_l, float32 iv_l, float32 iw_l,
                              float32 valmax_prtctn_l,
                              float32 ku_multiply_l) = &BreakPhasePrtctn;
...
retval_t (*pMaxUDCMotorPrtctn)(float32 udc_l,
                               float32 udc_nom_max_l) = &MaxUDCMotorPrtctn;
...
retval_t (*pMinUDCMotorPrtctn)(float32 udc_l,
                               float32 udc_nom_min_l) = &MinUDCMotorPrtctn;
 ...
 */
retval_t MaxMotorIPrtctn(float32 iu_la, float32 iv_la, float32 iw_la,
                         float32 valmax_prtctn_la)
{
    ...
    if (((iu_la * iu_la) > valmax_prtctn_la)
            || ((iv_la * iv_la) > valmax_prtctn_la)
 ...
 */
retval_t TimeIMotorPrtctn(float32 istator_la, float32 ki_sum_ti_la,
                          float32 i_nom_la, float32 *i_sum_ti_la,
                          float32 activ_intgr_prtctn_la)
{
 ...
 */
retval_t BreakPhasePrtctn(float32 urefu_la, float32 urefv_la, float32 urefw_la,
                          float32 iu_la, float32 iv_la, float32 iw_la,
                          float32 valmax_prtctn_la, float32 ku_multiply_la)
{
    //! initial state declaration
    retval_t StatMotorErr = SUCCESS;
