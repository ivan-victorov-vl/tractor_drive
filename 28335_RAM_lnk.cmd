...
PAGE 0 :
   ...
   RAML0      : origin = 0x008000, length = 0x000700
   RAML1L2L3  : origin = 0x008700, length = 0x003300
...
PAGE 1 :
   ...
   RAMM1      : origin = 0x000380, length = 0x000380     /* on-chip RAM block M1 */
   RAML4      : origin = 0x00C000, length = 0x001500
   RAML5      : origin = 0x00D500, length = 0x000800
   RAML6      : origin = 0x00E300, length = 0x000700
