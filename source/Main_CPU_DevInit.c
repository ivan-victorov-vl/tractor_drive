...
//	SYSTEM CLOCK speed based on Crystal = 25 MHz
//	0xF =  187.5 MHz		(15)
//	0xE =  175   MHz		(14)
//	0xD =  162.5 MHz		(13)
//	0xC =  150   MHz		(12)
...
//	0x3 =  37.5	MHz		(3)
//	0x2 =  25	MHz		(2)
	PllSet(0xC,2); // Choose from options above based on the reference crystal.
...
//  GPIO-24 - PIN FUNCTION (DX_ETH)
		GpioCtrlRegs.GPAMUX2.bit.GPIO24  = 	3; 				// 0=GPIO,  1=ECAP1,  2=EQEPA-2,  3=MDX-B
...
//  GPIO-25 - PIN FUNCTION (DR_ETH)
		GpioCtrlRegs.GPAMUX2.bit.GPIO25  = 	3; 				// 0=GPIO,  1=ECAP2,  2=EQEPB-2,  3=MDR-B
...
//  GPIO-26 - PIN FUNCTION (CLK_ETH)
		GpioCtrlRegs.GPAMUX2.bit.GPIO26  = 	3; 				// 0=GPIO,  1=ECAP3,  2=EQEPI-2,  3=MCLKX-B
...
//--------------------------------------------------------------------------------------
//  GPIO-35 - PIN FUNCTION (TX2_RS485) 
...
//  GPIO-36 - PIN FUNCTION (RX2_RS485) 
		GpioCtrlRegs.GPBMUX1.bit.GPIO36  = 	1; 				// 0=GPIO,  1=SCIA-RX,  2=Resv,  3=Resv
...
//  GPIO-37 - PIN FUNCTION (DE2_RS485) 
		GpioCtrlRegs.GPBMUX1.bit.GPIO37  = 	1; 				// 0=GPIO,  1=SCIA-RX,  2=Resv,  3=Resv
		GpioCtrlRegs.GPBDIR.bit.GPIO37   = 	0; 				// 1=OUTput,  0=INput 
		DE2_RS485_clear = 1;

//  GPIO-38 - PIN FUNCTION
...
//  GPIO-62 - PIN FUNCTION (RX1_RS485)
		GpioCtrlRegs.GPBMUX2.bit.GPIO62  = 	1; 				// 0=GPIO,  1=SCIRX-C,  2=XD17,  3=Resv
		GpioCtrlRegs.GPBDIR.bit.GPIO62   = 	0; 				// 1=OUTput,  0=INput 

//  GPIO-63 - PIN FUNCTION (TX1_RS485)
		GpioCtrlRegs.GPBMUX2.bit.GPIO63  = 	1; 				// 0=GPIO,  1=SCITX-C,  2=XD16,  3=Resv
		GpioCtrlRegs.GPBDIR.bit.GPIO63   = 	1; 				// 1=OUTput,  0=INput 

//  GPIO-64 - PIN FUNCTION (DE1_RS485)
		GpioCtrlRegs.GPCMUX1.bit.GPIO64  = 	0; 				// 0=GPIO,
		GpioCtrlRegs.GPCDIR.bit.GPIO64   = 	1; 				// 1=OUTput,  0=INput 
		DE1_RS485_clear = 1;

//  GPIO-65 - PIN FUNCTION (RS485_PON)
		GpioCtrlRegs.GPCMUX1.bit.GPIO65  = 	0; 				// 0=GPIO,  
		GpioCtrlRegs.GPCDIR.bit.GPIO65   = 	1; 				// 1=OUTput,  0=INput 
		RS485_PON_clear = 1;

//  GPIO-66 - PIN FUNCTION (RS485_PG)
