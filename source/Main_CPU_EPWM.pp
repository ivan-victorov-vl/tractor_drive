...
void InitEPwm_4_6Timers(int16 prd, int16 sync_lnth, int16 start_lnth)
{
	...
	EPwm4Regs.TBPRD 			= prd;				
	EPwm4Regs.CMPA.half.CMPA	= 20;				
	EPwm4Regs.CMPB 				= sync_lnth+20;		
	EPwm4Regs.TBCTL.bit.CTRMODE = 0;				

	EPwm4Regs.ETSEL.bit.INTSEL 	= 0x4;		
	EPwm4Regs.ETSEL.bit.INTEN 	= 1;				
	EPwm4Regs.ETPS.bit.INTPRD	= 1;				
 
    
	EPwm4Regs.AQCTLA.bit.CAU = 0x2;				
	EPwm4Regs.AQCTLA.bit.CBU = 0x1;			
	EPwm4Regs.AQCTLB.bit.ZRO = 0x2;				
	EPwm4Regs.AQCTLB.bit.CBU = 0x1;			

	EPwm4Regs.AQSFRC.all = 0x30;					
	...
	EPwm6Regs.TBPRD 			= prd;				
	EPwm6Regs.CMPA.half.CMPA 	= sync_lnth + 20 + 20;	
	EPwm6Regs.CMPB 				= start_lnth + 20 +20;	
	EPwm6Regs.TBCTL.bit.CTRMODE = 0;				

	EPwm6Regs.ETSEL.bit.INTSEL 	= 0x6;		
