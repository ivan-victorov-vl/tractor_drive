...
void sel_SPI_dev(Uint16 device);
...
void InitMAX7301(Uint16 device)
{
	...
	SpiaRegs.SPITXBUF = 0x0000 + 0x0900 + 0xFF;		
	SpiaRegs.SPITXBUF = 0x0000 + 0x0A00 + 0xFF;		
	SpiaRegs.SPITXBUF = 0x0000 + 0x0B00 + 0xFF;	

	SpiaRegs.SPITXBUF = 0x0000 + 0x0C00 + 0x55;	
	SpiaRegs.SPITXBUF = 0x0000 + 0x0D00 + 0x55;	
	SpiaRegs.SPITXBUF = 0x0000 + 0x0E00 + 0x55;	

	
	SpiaRegs.SPITXBUF = 0x0000 + 0x4C00 + 0xF0;			
	SpiaRegs.SPITXBUF = 0x0000 + 0x5400 + 0xFF;			

	
	SpiaRegs.SPITXBUF = 0x0000 + 0x0400 + 0x1; 
